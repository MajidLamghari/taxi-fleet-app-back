...
exports.getRides = async function (req, res, next) {
    try {
        ...
        return res.status(200).json({ status: 200, data: rides, message: "Succesfully Drives Retrieved" });
    } catch (e) {
...
exports.calclulatePrice = async function(req, res, next) {
    try {
        ...
        return res.status(200).json({ status: 200, data: price, message: "Succesfully Price Calculated" });
    } catch (e) {
        return res.status(400).json({ status: 400, message: e.message });
    }
}